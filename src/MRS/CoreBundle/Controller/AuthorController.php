...
class AuthorController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('MRSModelBundle:Author')->findAll();
     ...
     * @Method("POST")
     * @Template("MRSCoreBundle:Author:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('MRSModelBundle:Author')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("MRSCoreBundle:Author:edit.html.twig")
     */
